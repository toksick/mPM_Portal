...
<div class="row">
	<div class="col-md-6 col-lg-4">
		<div class="panel panel-default">
			<ul class="list-group">
				...
				<li class="list-group-item list-group-item-danger">Dapibus ac
					facilisis in</li>
				<li class="list-group-item list-group-item-warning">Morbi leo risus</li>
				<li class="list-group-item list-group-item-success">Porta ac
					consectetur ac</li>
			</ul>
		</div>
	</div>
	...
	<div class="col-md-12 col-lg-4">
		<div class="panel panel-default">
			<div class="panel-body">Sed ut perspiciatis unde omnis iste natus
